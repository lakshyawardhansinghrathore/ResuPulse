...
# Location and privacy detection
def detect_location_info(text: str, nlp: spacy.Language) -> Dict:
    ...
    # 2. Street address pattern matching
    ...
    # 3. ZIP/PIN code pattern matching
...
def _calc_ats_compatibility_score(
    ...
    # 1. Location privacy deduction
    score -= location_results.get('penalty_applied', 0.0)

    # 2. Non-standard special character deduction
    ...
    # 3. Truncated or excessively short sections deduction
    short_sections = sum([
